      ...
      content: [
            ...
            [
              {
                text: `Order Date: ${new Date(
                  theLastOrder.createdAt
                ).toLocaleDateString()}`,
                alignment: 'right',
              },
              {
                text: `Shipping Date: ${new Date(
                  theLastOrder.shipDate
                ).toLocaleDateString()}`,
                alignment: 'right',
              },
              {
                text: `Credit Card: ${theLastOrder.creditCard
                  .toString()
                  .slice(-4)
                  .padStart(theLastOrder.creditCard.toString().length, '*')}`,
                alignment: 'right',
              },
              {
        ...
        },
        {
          table: {
            ...
            body: [
              [
                { text: 'Product', bold: true, fillColor: 'beige' },
                { text: 'Price', bold: true, fillColor: 'beige' },
                { text: 'Quantity', bold: true, fillColor: 'beige' },
                { text: 'Amount', bold: true, fillColor: 'beige' },
              ],
              ...cartItems.map((c) => [
              ...
              [
                { text: 'Total Amount', bold: true, fillColor: 'pink' },
                { text: '', fillColor: 'pink' },
                { text: '', fillColor: 'pink' },
                {
          ...
          ul: [
            {
              text: 'Linkedin',
              color: 'blue',
              link: 'https://www.linkedin.com/in/eransam/',
            },

            {
              text: 'Github',
              color: 'blue',
              link: 'https://github.com/eransam/',
            },

            {
              text: 'WakaTime',
              color: 'blue',
              link: 'https://wakatime.com/@eransam/',
            },

            {
              text: 'NPM',
              color: 'blue',
              link: 'https://www.npmjs.com/~eransam/',
            },

            {
              text: 'Docker Hub',
              color: 'blue',
              link: 'https://hub.docker.com/u/jeransam/',
            },
          ],
        },
        {
