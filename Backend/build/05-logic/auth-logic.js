        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    ...
                    return [4 /*yield*/, user_model_1.UserModel.findOne({ username: user.id }).exec()];
                case 1:
                    existsUserId = _a.sent();
                    if (existsUserId)
                        throw new error_model_1.default(400, "Username ".concat(user.id, " This ID already exists in the system."));
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    ...
                    return [4 /*yield*/, user_model_1.UserModel.find({ id: credentials.id }).exec()];
                case 1:
                    users = _a.sent();
                    user = users[0];
