...
var cate_logic_1 = __importDefault(require("../05-logic/cate-logic"));
var cate_model_1 = require("../03-models/cate-model");
var router = express_1.default.Router();
//http://localhost:3002/api/cate/
router.get('/cate', function (request, response, next) { return __awaiter(void 0, void 0, void 0, function () {
    var categories, err_1;
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                _a.trys.push([0, 2, , 3]);
                return [4 /*yield*/, cate_logic_1.default.getAllCate()];
            case 1:
                categories = _a.sent();
...
router.post('/cate', function (request, response, next) { return __awaiter(void 0, void 0, void 0, function () {
    var cate, addedCate, err_2;
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                _a.trys.push([0, 2, , 3]);
                console.log("request.body: ", request.body);
                cate = new cate_model_1.CateModel(request.body);
                console.log("cate: ", cate);
                return [4 /*yield*/, cate_logic_1.default.addCate(cate)];
            case 1:
                addedCate = _a.sent();
...
router.post('/products', verify_admin_1.default, function (request, response, next) { return __awaiter(void 0, void 0, void 0, function () {
    var product, addedProduct, err_3;
    var _a;
...
router.put('/products/:_id', verify_admin_1.default, function (request, response, next) { return __awaiter(void 0, void 0, void 0, function () {
    var _id, product, updatedProduct, err_7;
    var _a;
    return __generator(this, function (_b) {
        switch (_b.label) {
            case 0:
